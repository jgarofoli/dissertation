...
\def\Dstarzz  {\ensuremath{\D^{*0}_{2}}\xspace}
...
\def\Xsm     {\ensuremath{X_s^-}\xspace}
\def\Xsp     {\ensuremath{X_s^+}\xspace}
\def\Xspm    {\ensuremath{X_s^\pm}\xspace}
\def\Xdsm    {\ensuremath{X_{d,s}^-}\xspace}
\def\Xsdm    {\ensuremath{X_{s,d}^-}\xspace}
\def\Xdm     {\ensuremath{X_d^-}\xspace}
\def\Xdp     {\ensuremath{X_d^+}\xspace}
\def\Xdpm    {\ensuremath{X_d^\pm}\xspace}
...
\def\CP                {\ensuremath{CP}\xspace}
\def\CPT               {\ensuremath{CPT}\xspace}
